    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuToolbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(RecreationActivity.this, MenuActivity.class);
        ...
        kavinooProfile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(RecreationActivity.this, ProfileActivity.class);
                startActivity(intent);
            }
        });
    ...
    public void getRecreationPlaces(){
        ...
        final StringRequest recreationReq = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                CookieBar.Builder c = CookieBar.build(RecreationActivity.this);
