...
public class PlacesListAdapter extends RecyclerView.Adapter<PlacesListAdapter.PlaceListViewHolder> {

    List<PlacesItem> placesItemList;
    Context context;

    public PlacesListAdapter(List<PlacesItem> placesItemList, Context context) {
    ...
    public PlaceListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new PlacesListAdapter.PlaceListViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.places_item,parent,false));
    }
